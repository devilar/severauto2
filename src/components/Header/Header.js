...
const Header = ({...props}) => {
    ...
    return (
        <Grid className='header' container height='90px' alignItems='center' {...props}>
            ...
            <Grid item spacing={0} xs={8}><Typography color='#ffffff' align='center' component="h3" variant="p">Север-авто</Typography></Grid>
            <Grid item spacing={0} xs={2}><HeaderProfile/></Grid>
